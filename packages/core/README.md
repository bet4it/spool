...
// Sync new sessions from Claude, Codex, Gemini, Antigravity, OpenCode, Grok Build
...
- **Session parsers** — reads Claude Code, Codex, Gemini, Antigravity, OpenCode, and Grok Build sessions
