...
describe('migration v18: parent session relationships', () => {
  it('adds the parent column and index to a v17 database', () => {
    ...
    // simulate the v17 shape (no parent_session_uuid) in a fresh table.
    db.exec(`
      ALTER TABLE sessions RENAME TO sessions_v18;
